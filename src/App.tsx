  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="w-full lg:w-[46%] max-w-[620px] animate-hero-text">
            ...
            >
              Car booking with professional driver & 24/7 VIP airport
              <br className="hidden sm:block" />
              pick & drop services across Pakistan
            </p>

            {/* Feature Badges */}
            <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center" }} className="gap-y-4">
              <div
                style={{
                  display: "flex",
              ...
              >
                <ShieldIcon />
                <span style={{ fontSize: 13, fontWeight: 500, color: "#6b7f96" }}>With Driver</span>
              </div>
              ...
              >
                <CarBadgeIcon />
                <span style={{ fontSize: 13, fontWeight: 500, color: "#6b7f96" }}>Airport Transfers</span>
              </div>
              <div style={{ width: 1, height: 50, background: "#c8d8e4" }} />
              <div
                style={{
              ...
              >
                <ClockBadgeIcon />
                <span style={{ fontSize: 13, fontWeight: 500, color: "#6b7f96" }}>24/7 Availability</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white py-3 px-4 rounded-full shadow-[0_10px_30px_rgba(37,211,102,0.4)] hover:scale-105 transition-transform flex items-center gap-2.5 font-bold text-xs"
